...
function onChange(value) {
	localStorage.setItem("adda",value[0]); 
	localStorage.setItem("addb",value[1]); 
	localStorage.setItem("addc",value[2]); 
  console.log(value);
}

ReactDOM.render(
  <antd.Cascader options={options} onChange={onChange} placeholder="城市" />,
